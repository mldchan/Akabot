...
class Welcoming(discord.Cog):
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        message_text = get_setting(member.guild.id, 'welcome_text', 'Welcome {user} to {server}!') # text of the message or description of embed
    ...
    async def on_member_remove(self, member: discord.Member):
        ...
        message_text = get_setting(member.guild.id, 'goodbye_text', 'Goodbye {user}!') # text of the message or description of embed
